      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-2xl border border-slate-200 p-6 sm:p-10 shadow-xs space-y-8 text-sm text-slate-700 leading-relaxed">
          ...
          <div>
            ...
            <p>
              By providing your telephone number on this website or calling <strong>877-701-1129</strong>, you grant express consent to receive telephone calls, automated dispatch notifications, and SMS/text messages from Leak Detection Pro and our matched independent plumbing partners regarding your service inquiry, even if your phone number is registered on any state or federal Do-Not-Call registry. Consent is not a condition of purchase; message and data rates may apply.
            </p>
          </div>
          ...
          <div className="bg-slate-50 border border-slate-200 p-5 rounded-xl space-y-2">
            ...
            <p className="text-xs text-slate-600 pt-2">
              To exercise these rights, please contact our compliance desk at <strong>877-701-1129</strong> or via mail at <strong>3431 43rd St, San Diego, CA 92105</strong>.
            </p>
          </div>
          ...
          <div className="pt-4 border-t border-slate-200 text-xs text-slate-500 space-y-1">
            ...
            <p><strong>Phone:</strong> (877) 701-1129</p>
