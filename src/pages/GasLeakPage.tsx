...
export const GasLeakPage: React.FC<GasLeakPageProps> = ({ onNavigate, onOpenQuote }) => {
  ...
  const gasFaqs = [
    ...
    },
    {
      ...
      a: 'When SDG&E identifies a leak, they shut off the main meter and place a red safety tag. By California law, the gas line must be inspected, pressure tested with a certified gauge, and repaired by a licensed plumbing/gas contractor. The city or SDG&E requires an air pressure test clearance before they will unlock the meter.'
    },
    {
      q: 'What causes gas line leaks in older City Heights properties?',
      a: 'Many homes in City Heights feature vintage black iron pipe with threaded joints that deteriorate over decades from foundation settlement, earthquakes, or seismic vibrations along the I-15 corridor, causing dried joint dope and microscopic leaks at pipe elbows.'
    },
    {
  ...
  return (
    <div className="space-y-16 pb-16">
      ...
      <div className="bg-red-700 text-white px-4 py-2.5 text-xs font-semibold text-center flex items-center justify-center gap-2">
        ...
        <span>
          Emergency Safety Notice: If you smell strong gas odor right now, evacuate immediately and call 911 or SDG&E at 1-800-411-7343!
        </span>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-8 space-y-4">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-amber-800/60 border border-amber-600/60 text-xs text-amber-200">
                ...
                <span>City Heights Gas Safety & Contractor Referral</span>
              </div>

              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight text-white leading-tight">
                Emergency <span className="text-amber-400">Gas Leak Detection</span> & Line Safety in City Heights, CA
              </h1>

              <p className="text-base text-slate-200 max-w-2xl leading-relaxed">
                Connect 24/7 with pre-screened, licensed gas line plumbing specialists in City Heights (92105). Fast electronic sniffing, pressure drop testing, and red-tag meter clearance repairs.
              </p>
            ...
            <div className="lg:col-span-4 bg-slate-800/80 border border-slate-700 rounded-2xl p-5 text-xs space-y-3 overflow-hidden">
              ...
              <ul className="space-y-2 text-slate-300">
                ...
                <li className="flex items-center gap-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-amber-400" />
                  <span>SDG&E red tag lock removal support</span>
                </li>
                <li className="flex items-center gap-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-amber-400" />
              ...
              <div className="pt-2 border-t border-slate-700 text-[11px] text-slate-400">
                Local Base: 3431 43rd St, City Heights, CA 92105
              </div>
            </div>
          </div>
        </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-xs">
                  ...
                  <h3 className="font-bold text-base text-slate-900 mb-1">SDG&E Lock & Tag Clearances</h3>
                  <p className="text-xs text-slate-600 leading-relaxed">
                    Conducting required municipal pressure test documentation so SDG&E will safely unlock the gas meter and restore service.
                  </p>
                </div>
              </div>
            </div>
