      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden sm:flex items-center gap-3">
            <a
              href={BUSINESS_INFO.telLink}
              className="flex items-center gap-2.5 bg-red-600 hover:bg-red-700 text-white px-4 py-2.5 rounded-xl font-bold shadow-md shadow-red-600/20 transition-all hover:scale-102 active:scale-98"
              id="header-call-btn"
            >
            ...
            <button
              onClick={onOpenQuote}
              className="hidden xl:inline-flex px-3.5 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-800 rounded-xl text-sm font-semibold transition-colors border border-slate-300"
              id="header-quote-btn"
            >
              Get Dispatch Quote
            </button>
          ...
          <div className="flex items-center gap-2 lg:hidden">
            <a
              href={BUSINESS_INFO.telLink}
              className="p-2.5 bg-red-600 text-white rounded-xl flex items-center justify-center shadow-xs"
