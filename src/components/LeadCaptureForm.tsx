...
export const LeadCaptureForm: React.FC<LeadCaptureFormProps> = ({
  ...
  const [zip, setZip] = useState('92105');
    ...
    >
      <div className="mb-6">
        ...
        <p className="text-xs text-slate-500 mt-1">
          Connect with pre-screened, licensed San Diego leak specialists. Zero obligation quote.
        </p>
      </div>
        ...
        <div className="grid grid-cols-3 gap-3">
          <div className="col-span-2">
            <label className="block text-xs font-semibold text-slate-700 mb-1" htmlFor="lead-address">
              Street / Cross Streets (City Heights Area)
            </label>
            <input
              id="lead-address"
              type="text"
              placeholder="e.g. 43rd St / University Ave"
              value={address}
